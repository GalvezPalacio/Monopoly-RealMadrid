...
public class GeneradorMensajesComunidad {
    ...
    static {
        // Positivos
        mensajesPositivos.add("🎓 Has ganado una beca de la Fundación Real Madrid. Recibes 100€.");
        ...
        mensajesPositivos.add("🏅 El club te nombra 'socio del año'. Premio de 300€.");
        mensajesPositivos.add("📝 Participaste en una encuesta de socios. Te pagan 90€.");
        mensajesPositivos.add("🧾 Recibes un vale de exención. En tu próxima multa, no pagas.");
        mensajesPositivos.add("💼 Trabajas en la tienda del Bernabéu. Cobras 110€.");
        ...
        // Negativos
        mensajesNegativos.add("🏫 Tu hijo entra en la escuela del Real Madrid. Pagas matrícula: 150€.");
        ...
        mensajesNegativos.add("🚗 Dejas el coche mal aparcado en Chamartín. Multa de 80€.");
        mensajesNegativos.add("⚽ Fallas un penalti en la presentación de peñas. Te multan 70€.");
        ...
        mensajesNegativos.add("🎆 Sanción por encender bengalas en el estadio. Pagas 140€.");
    }
