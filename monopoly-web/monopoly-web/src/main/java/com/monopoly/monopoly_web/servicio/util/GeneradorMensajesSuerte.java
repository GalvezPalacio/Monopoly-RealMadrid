...
public class GeneradorMensajesSuerte {
    ...
    static {
        ...
        mensajesPositivos.add("📺 Has firmado un contrato con Real Madrid TV. Recibes 120€.");
        ...
        mensajesNegativos.add("🚑 Bellingham se lesiona. Pagas 150€ en médicos.");
        mensajesNegativos.add("📉 Inviertes mal en NFTs del Madrid. Pierdes 200€.");
        mensajesNegativos.add("🥶 Te colaste en un palco sin entrada. Multa de 100€.");
        mensajesNegativos.add("⚖️ Pierdes una demanda de marca. Pagas 120€.");
        mensajesNegativos.add("💸 Compras entradas falsas del Clásico. Pierdes 180€.");
        mensajesNegativos.add("🏴‍☠️ Has comprado una camiseta pirata. Multa de 90€.");
        mensajesNegativos.add("🎮 Pierdes un torneo de FIFA contra un culé. Pagas 70€.");
